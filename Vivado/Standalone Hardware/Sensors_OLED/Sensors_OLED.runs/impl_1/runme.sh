...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Sensors_OLED/Sensors_OLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensors_OLED_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sensors_OLED_wrapper.tcl -notrace
