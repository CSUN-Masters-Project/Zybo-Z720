...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Pmod_OLED/Pmod_OLED.runs/Pmod_OLED_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_OLED_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pmod_OLED_auto_pc_0.tcl
