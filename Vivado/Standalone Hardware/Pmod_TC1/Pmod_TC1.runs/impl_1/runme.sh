...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Pmod_TC1/Pmod_TC1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_TC1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pmod_TC1_wrapper.tcl -notrace
