...
--Command     : generate_target Sensors_OLED_wrapper.bd
...
entity Sensors_OLED_wrapper is
  port (
    CS : out STD_LOGIC;
...
end Sensors_OLED_wrapper;

architecture STRUCTURE of Sensors_OLED_wrapper is
  component Sensors_OLED is
  port (
    MISO : in STD_LOGIC;
    CS : out STD_LOGIC;
    SCK : out STD_LOGIC;
...
Sensors_OLED_i: component Sensors_OLED
     port map (
      CS => CS,
