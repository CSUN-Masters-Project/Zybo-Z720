...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Pmod_TMP3/Pmod_TMP3.runs/Pmod_TMP3_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_TMP3_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pmod_TMP3_auto_pc_0.tcl
