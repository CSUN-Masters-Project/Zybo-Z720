...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Pmod_TC1/Pmod_TC1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_TC1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pmod_TC1_wrapper.tcl
