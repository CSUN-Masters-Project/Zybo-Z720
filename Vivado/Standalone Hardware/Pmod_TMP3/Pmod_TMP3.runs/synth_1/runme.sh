...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Pmod_TMP3/Pmod_TMP3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_TMP3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pmod_TMP3_wrapper.tcl
