...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Sensors_OLED/Sensors_OLED.runs/Sensors_OLED_PmodTC1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensors_OLED_PmodTC1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sensors_OLED_PmodTC1_0_0.tcl
