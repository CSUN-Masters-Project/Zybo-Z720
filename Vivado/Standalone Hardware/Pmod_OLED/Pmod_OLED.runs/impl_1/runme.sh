...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Pmod_OLED/Pmod_OLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_OLED_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pmod_OLED_wrapper.tcl -notrace
