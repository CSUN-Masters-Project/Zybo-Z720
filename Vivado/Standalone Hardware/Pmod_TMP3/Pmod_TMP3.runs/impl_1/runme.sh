...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Pmod_TMP3/Pmod_TMP3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_TMP3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pmod_TMP3_wrapper.tcl -notrace
